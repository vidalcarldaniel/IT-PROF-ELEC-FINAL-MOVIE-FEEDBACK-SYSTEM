      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-3 md:py-4">
        ...
        <nav className="hidden md:flex gap-6 text-gray-300 font-medium">
         <Link
          ...
          <Link
            to="/signup"
            className="bg-orange-400 text-neutral-900 px-3 py-1 rounded-full font-semibold hover:bg-orange-500 transition-colors"
          >
            Sign Up
          </Link>
        </nav>
          ...
          <nav className="flex flex-col items-center py-3 space-y-3 text-gray-300 font-medium">
           <Link
            ...
            <Link
              to="/signup"
              onClick={() => setIsOpen(false)}
              className="bg-orange-400 text-neutral-900 px-4 py-2 rounded-full font-semibold hover:bg-orange-500 transition-colors"
            >
              Sign Up
            </Link>
          </nav>
